...
{
	m_timeShader = new Shader{ "../../assets/shaders/Oscilloscope_TimeVertex.vs","../../assets/shaders/Oscilloscope_TimeFragment.fs" };
	m_freqShader = new Shader{ "../../assets/shaders/Oscilloscope_FrequencyVertex.vs","../../assets/shaders/Oscilloscope_FrequencyFragment.fs" };
