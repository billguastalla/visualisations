...
void PostProcessing::initShaders()
{
	...
	if (m_mainShader == nullptr)
		m_mainShader = new Shader{ "../../assets/shaders/Rescale/rescale.vs", "../../assets/shaders/Rescale/rescale.fs" };
	/////////////////////////////////////////////////////////////////////////////
	...
	/* HDR: Set up shader */
	//m_hdrShader = new Shader{ "../../assets/shaders/Bloom/hdr.vs","../../assets/shaders/Bloom/hdr.fs" };
	if (m_bloomShader == nullptr)
		m_bloomShader = new Shader{ "../../assets/shaders/Bloom/bloom.vs","../../assets/shaders/Bloom/bloom.fs" };
	if (m_blurShader == nullptr)
		m_blurShader = new Shader{ "../../assets/shaders/Bloom/blur.vs", "../../assets/shaders/Bloom/blur.fs" };
	//shader.use();
