...
//														 // --------------------
//	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Render to file", NULL, NULL);
//	if (window == NULL)
//	{
...
//	// ------------------------------------
//	Shader objectShader("2b-vertex.vs", "2b-fragment.fs");
//	Shader lampShader{ "2b-vertex.vs", "2b-lampFragment.fs" };
//
...
//		// activate shader
//		objectShader.use();
//		objectShader.setVec3("lightColour", glm::vec3{ 1.0f,0.5f,0.31f });
//		objectShader.setVec3("objectColour", glm::vec3{ 1.0f,1.0f,1.0f });
//
...
//		lightPos = glm::vec3(5 * sin(0.1 * glfwGetTime()), 10 * cos(glfwGetTime()), 10 * sin(glfwGetTime()));
